...
def help_embed() -> discord.Embed:
    embed = discord.Embed(
        ...
        description=(
            ...
            "NY 12:00 UTC) in **strict mode**: only score ≥ 8/12, RR ≥ 2.0, "
            "M5 confirmed, IDM confirmed, news-clear setups are posted."
        ),
        color=COLOR_INFO,
    )
    embed.add_field(
